    ...
    try {
      if (import.meta.env.VITE_SUPABASE_URL?.includes('placeholder')) {
        useAuthStore.getState().setUser({
          id: 'mock-id', email, full_name: name, units: 'metric', theme: 'system', onboarding_complete: true, created_at: '', updated_at: ''
        });
        navigate('/dashboard');
        return;
      }
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="glass-card py-8 px-4 sm:px-10">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground mt-2">Start your nutrition journey today</p>
          </div>
